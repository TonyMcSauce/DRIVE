...
(()=>{
  ...
  function openComponentsDB(){
    ...
    dbPromise=new Promise((resolve,reject)=>{
      ...
      request.onupgradeneeded=event=>{
        ...
        addIndex("vehicleId","vehicleId");addIndex("category","category");addIndex("name","name");addIndex("updatedAt","updatedAt");
      };
  ...
  async function render(){
    styles();
    const mount=document.getElementById("carComponentsMount");if(!mount)return;
    const vehicle=await activeVehicle();if(!vehicle)return;
