...
(() => {
    ...
    function mount(){
        ...
        view.innerHTML=`<div class="page-heading"><span class="eyebrow">VEHICLE INTELLIGENCE</span><h1 id="analytics-title">Analytics</h1></div><div id="analyticsKpis" class="analytics-kpis"></div><div class="analytics-panel"><header><span>RUNNING COST · 6 MONTHS</span></header><div id="analyticsCostChart" class="analytics-bars" role="img" aria-label="Six month running cost chart"></div></div><div class="analytics-panel"><header><span>SPEND BREAKDOWN · THIS MONTH</span></header><div id="analyticsBreakdown" class="analytics-list"></div></div></section>`;
    ...
    document.addEventListener("DOMContentLoaded",()=>{mount();window.DRIVE_ANALYTICS={refresh:render};});
})();
